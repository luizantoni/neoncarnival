...
GltfContainer.create(fruitzapper, {
  src: 'models/shooting-range/finalfruit4.glb',
})
...
Animator.create(Fase1, {
 ...
 if (fullscoreantonio >= 480 ) {
  (fullscoreantonio = 490)
  let fase3 = engine.addEntity()
...
GltfContainer.create(nivel2, {
  src: 'models/shooting-range/LEVEL2_VAANISH.glb'
})
...
Animator.playSingleAnimation(nivel2, '1', true )
        ...
        function DanceVictory2() {
          ...
          if ( fullscoreantonio >= 400 && fullscoreantonio <= 470 ) {  
            
            

            (fullscoreantonio = 480) 
            ...
            GltfContainer.create(nivel3, {
              src: 'models/shooting-range/LEVEL3_VAANISH.glb'
            })
          ...
          DanceVictory2() 
            ...
            if ( fullscoreantonio >= 700 && fullscoreantonio <= 950 ) {  
              
              

               (fullscoreantonio = 700) 
              // const clipAnim = Animator.getClip(newshoting, 'Animation')
            ...
            GltfContainer.create(nivel4, {
              src: 'models/shooting-range/WIN_VANISH.glb'
            })
