...
import { Schemas, engine, Entity, Transform, GltfContainer, ColliderLayer, Animator } from '@dcl/sdk/ecs'

import  { } from './player-shooting-area';

import { variavelState } from './player-shooting-area';
...
export module TargetObject {
  ...
  const MODEL_TARGET_OBJECT = 'models/shooting-range/finalfrtit4.glb'
